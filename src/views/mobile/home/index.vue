  ...
  <div class="mobile-home-container">
    ...
    <div class="mobile-home-container-body">  
      ...
      <div  class="mobile-home-node" v-if="data.dataNode && currency">
        <CardNav :title="$t('title.node_information') + '（' + $t('title.total').replace('xxx',data.dataNode.num + data.oreBasins.num + data.independentConsensusNode.num) + '）'" @loadMore="loadMoreNode"/>
