    ...
    <div class="middle-block _block">
      <div class="middle-item">
        ...
        <div class="middle-item-content-1">
          <!-- <el-tooltip :content="allData.tradingHash" placement="top-start"> -->
    ...
    <div class="_block main-info">
      ...
      <div class="item-row">
        ...
        <div class="item-content">
          ...
          <span v-show="allData.status == 3">{{$t('title.找不到交易')}}</span>
        </div>
      </div>
      <!-- 所属区块 -->
      <div class="item-row">
     ...
     <!-- 接收者 type == 3-->
      ...
      <!-- 输入数据 type != 4-->
      <!-- v-if="allData.childrenTxTypeName != 'select.across_chain_trading_withdrawal' && !(allData.parentTxTypeName == 'select.contract_trading' && allData.chainId == '103') && allData.parentTxTypeName != 'select.within_chain_trading'" -->
      <div class="item-row">
        <div class="item-title cta_all_con_left_last" style="line-height: 100px">
          {{$t('table.input_data')}}
        </div>
...
<!--    <el-button v-if="allData.inputData && currencyPc" @click="stringFrom16Decimal()" style="margin:40px" type="primary">{{$t('title.transform')}}</el-button>-->
