<template>
    <div class="header-wrap">
      ...
      <span class="header-title" v-if="!currencyPc">分布式商业区块链浏览器</span>
      <div class="header-right" v-if="currencyPc">
        ...
        <!-- <div class="tab-select-wrap" style="display: inline-block;text-align:center;marginLeft:30px">
          <el-dropdown trigger="click" >
              <span class="el-dropdown-link">
          {{language}}
            </span>
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item @click.native="languageSwitching('zh')">中文</el-dropdown-item>
              <el-dropdown-item @click.native="languageSwitching('en')">English</el-dropdown-item>
              <el-dropdown-item @click.native="languageSwitching('ja')">日本語</el-dropdown-item>
              <el-dropdown-item @click.native="languageSwitching('ko')">한국어</el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </div> -->
      </div>
      <!-- <div class="tab-select-wrap" style="display: inline-block;float: right;text-align:center">
        <el-dropdown trigger="click" >
            <span class="el-dropdown-link">
      ...
      <!-- <div class="go-home-wrap" style="display: inline-block;float: right">
        <span class="go-home" @click="goHome()">{{$t("header.header_home")}}</span>
      </div> -->
    </div>
